...
class MyFirstStrat(Strategy):
    ...
    def initialize(self):
        ...
        self.portfolio = [
            ...
            {
                "symbol": "NVDA",  # Nivida for expsoure to bitcoin/crypto...other options GBTC, COIN, RIOT
                "weight": 0.20,
                "last_price": None,
            },
            {
            ...
            {
                "symbol": "BOIL",  # Leveraged Natural Gas
                "weight": 0.05,
                "last_price": None,
            },
           {
